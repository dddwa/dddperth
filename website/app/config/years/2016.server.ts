        ...
        sessions: [
  {
    ...
    sponsors: {
        gold: [
            {
                name: 'Bankwest',
                logoUrlDarkMode: '/images/sponsors/2016-bankwest-dark.png',
                logoUrlLightMode: '/images/sponsors/2016-bankwest-light.png',
                website: 'https://www.bankwest.com.au/',
                quote: undefined,
            },
            {
                name: 'Readify',
                logoUrlDarkMode: '/images/sponsors/2016-readify-dark.png',
                logoUrlLightMode: '/images/sponsors/2016-readify-light.png',
                website: 'https://readify.net/',
                quote: undefined,
            },
            {
                name: 'Microsoft',
                logoUrlDarkMode: '/images/sponsors/2016-microsoft-dark.png',
                logoUrlLightMode: '/images/sponsors/2016-microsoft-light.png',
