...
export function Footer() {
  return (
    <styled.footer className={`global-footer`} position="relative" w="100%" display="flex" zIndex="10">
        ...
        >
          ...
          >
            <styled.div
              ...
              alignItems="flex-start"
            >
              <styled.a href={`/`} className={`${ctaButton({ visual: 'hyperlink', size: 'sm', width: 'full' })}`}>
                Home
              </styled.a>
            </styled.div>
            {menuData.map((item) => (
