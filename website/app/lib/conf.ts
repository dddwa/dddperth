...
export function isSimpleScheduleItemRaw(obj: any): obj is SimpleScheduleItemRaw {
    return (
        obj &&
        typeof obj === 'object' &&
        ...
        (!obj.speakers || (Array.isArray(obj.speakers) && obj.speakers.every((item: any) => typeof item === 'string')))
    )
}

export function isTalkScheduleItemRaw(obj: any): obj is TalkScheduleItemRaw {
    return obj && typeof obj === 'object' && typeof obj.time === 'string' && typeof obj.talk === 'string'
}
...
export function isScheduleItemRawWithSpeakers(obj: any): obj is SimpleScheduleItemRaw & { speakers: Array<string> } {
    return (
