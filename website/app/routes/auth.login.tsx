...
import { Form, redirect, useSearchParams, useActionData } from 'react-router'
import { authenticator, getUser, createUserSession } from '~/lib/auth.server'
...
export default function Login() {
  ...
  const error = actionData?.error || 
    (searchParams.get('error') === 'access_denied' ? 'Access denied. Admin privileges required.' : 
